/* ==========================================================================
   ...
   ★ 실험 데이터를 보내지 않습니다.
     plan 단계에 가는 것은 질문과 "도구 이름·설명·인자 형태" 뿐입니다.
     조회·필터·집계는 브라우저의 Repo 와 기존 엔진이 합니다. 모델은 값을
     본 적이 없으므로 값을 지어낼 재료 자체가 없습니다.
   ...
   ★ narrate 단계는 수치를 새로 만들 수 없습니다.
     확정된 결과에서 뽑은 "허용 수치 집합" 을 함께 받고, 모델 문장에
     그 밖의 수치가 있으면 서버가 문장을 버립니다. 브라우저의 AskVerify 와
     같은 검사를 한 번 더 하는 것입니다 — 두 겹이라 한 쪽이 뚫려도 남습니다.
   ========================================================================== */
