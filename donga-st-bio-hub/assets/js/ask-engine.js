    ...
    if (!S || !S.count()) {
      return Object.assign(base, {
        ...
        headline: "등록된 규격이 하나도 없어 Pass/Fail 을 판정할 수 없습니다. " +
          "값을 지어내 판정하지 않습니다.",
        hints: [
          /* 연구원 화면에는 규격 메뉴가 없습니다. 없는 메뉴로 안내하면
             찾다가 포기하고, 규격은 계속 0건으로 남습니다 —
             누구에게 말해야 하는지를 알려 주는 편이 실제로 등록됩니다. */
          "규격 한계값은 규제업무 담당자가 관리자 화면에서 등록합니다. " +
            "이 항목의 판정이 필요하시면 담당자에게 요청해 주세요.",
